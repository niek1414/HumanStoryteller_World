...
namespace HumanStoryteller.NewtonsoftShell.Newtonsoft.Json
{
	...
	public class JsonSerializer
	{
		...
		public virtual SerializationBinder Binder
		{
			get
			{
				SerializationBinder serializationBinder = _serializationBinder as SerializationBinder;
				if (serializationBinder != null)
				{
					return serializationBinder;
				}
				SerializationBinderAdapter serializationBinderAdapter = _serializationBinder as SerializationBinderAdapter;
		...
		private void SetupReader( JsonReader reader, out CultureInfo previousCulture, out DateTimeZoneHandling? previousDateTimeZoneHandling, out DateParseHandling? previousDateParseHandling, out FloatParseHandling? previousFloatParseHandling, out int? previousMaxDepth, out string previousDateFormatString)
		{
			...
			if (_dateTimeZoneHandling.HasValue)
			{
			...
			goto IL_019e;
			IL_008c:
			if (_dateParseHandling.HasValue)
			{
				DateParseHandling dateParseHandling = reader.DateParseHandling;
				DateParseHandling? dateParseHandling2 = _dateParseHandling;
			...
			goto IL_00e6;
			IL_00e6:
			if (_floatParseHandling.HasValue)
			{
		...
		internal virtual void SerializeInternal( JsonWriter jsonWriter, object value, Type objectType)
		{
			...
			if (_formatting.HasValue)
			{
				Formatting formatting2 = jsonWriter.Formatting;
				Formatting? formatting3 = _formatting;
				if (!((formatting2 == formatting3.GetValueOrDefault()) & formatting3.HasValue))
				{
			...
			if (_dateFormatHandling.HasValue)
			{
				DateFormatHandling dateFormatHandling2 = jsonWriter.DateFormatHandling;
				DateFormatHandling? dateFormatHandling3 = _dateFormatHandling;
				if (!((dateFormatHandling2 == dateFormatHandling3.GetValueOrDefault()) & dateFormatHandling3.HasValue))
				{
			...
			if (_dateTimeZoneHandling.HasValue)
			{
				...
				DateTimeZoneHandling? dateTimeZoneHandling3 = _dateTimeZoneHandling;
				if (!((dateTimeZoneHandling2 == dateTimeZoneHandling3.GetValueOrDefault()) & dateTimeZoneHandling3.HasValue))
				{
			...
			if (_floatFormatHandling.HasValue)
			{
				FloatFormatHandling floatFormatHandling2 = jsonWriter.FloatFormatHandling;
				FloatFormatHandling? floatFormatHandling3 = _floatFormatHandling;
				if (!((floatFormatHandling2 == floatFormatHandling3.GetValueOrDefault()) & floatFormatHandling3.HasValue))
				{
			...
			if (_stringEscapeHandling.HasValue)
			{
				StringEscapeHandling stringEscapeHandling2 = jsonWriter.StringEscapeHandling;
				StringEscapeHandling? stringEscapeHandling3 = _stringEscapeHandling;
				if (!((stringEscapeHandling2 == stringEscapeHandling3.GetValueOrDefault()) & stringEscapeHandling3.HasValue))
				{
