...
namespace HumanStoryteller.Incidents {
    class HumanIncidentWorker_RefugeePodCrash : HumanIncidentWorker {
        ...
        protected override IncidentResult Execute(HumanIncidentParams @params) {
            ...
            if (!(@params is HumanIncidentParams_RefugeePodCrash)) {
                Tell.Err("Tried to execute " + GetType() + " but param type was " + @params.GetType());
                return ir;
            }

            HumanIncidentParams_RefugeePodCrash
                allParams = Tell.AssertNotNull((HumanIncidentParams_RefugeePodCrash) @params, nameof(@params), GetType().Name);
    ...
    public class HumanIncidentParams_RefugeePodCrash : HumanIncidentParams {
