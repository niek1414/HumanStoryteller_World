...
namespace HumanStoryteller.Incidents {
    class HumanIncidentWorker_SpeedControl : HumanIncidentWorker {
        ...
        protected override IncidentResult Execute(HumanIncidentParams @params) {
            ...
            if (!(@params is HumanIncidentParams_SpeedControl)) {
                Tell.Err("Tried to execute " + GetType() + " but param type was " + @params.GetType());
                return ir;
            }

            HumanIncidentParams_SpeedControl
                allParams = Tell.AssertNotNull((HumanIncidentParams_SpeedControl) @params, nameof(@params), GetType().Name);
    ...
    public class HumanIncidentParams_SpeedControl : HumanIncidentParams {
