...
namespace HumanStoryteller.Util.Overlay.BubbleType {
    ...
    public class ShoutBubble : IBubbleType {
        ...
        private static readonly Texture2D StaticPointer = ContentFinder<Texture2D>.Get("shout-pointer");
        ...
        private const float StaticMaxLineOpacity = 1f;
        private const float StaticMaxTextOpacity = 0.83f;
