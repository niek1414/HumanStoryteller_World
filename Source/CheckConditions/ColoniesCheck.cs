...
namespace HumanStoryteller.CheckConditions {
    public class ColoniesCheck : CheckCondition {
        ...
        public ColoniesCheck(DataBank.CompareType compareType, float constant) {
        ...
        public override bool Check(IncidentResult result, int checkPosition) {           
            return DataBank.CompareValueWithConst(Find.Maps.FindAll(x => x.ParentFaction.IsPlayer).Count, _compareType, _constant);
        }
