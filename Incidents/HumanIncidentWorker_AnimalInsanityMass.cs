...
class HumanIncidentWorker_AnimalInsanityMass : HumanIncidentWorker {
    ...
    protected override IncidentResult Execute(HumanIncidentParams @params) {
        ...
        if (!(@params is HumanIncidentParams_AnimalInsanityMass)) {
            Tell.Err("Tried to execute " + GetType() + " but param type was " + @params.GetType());
            return ir;
        }

        HumanIncidentParams_AnimalInsanityMass allParams =
            Tell.AssertNotNull((HumanIncidentParams_AnimalInsanityMass) @params, nameof(@params), GetType().Name);
...
public class HumanIncidentParams_AnimalInsanityMass : HumanIncidentParams {
