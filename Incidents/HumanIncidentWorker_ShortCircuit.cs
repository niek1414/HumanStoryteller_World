...
class HumanIncidentWorker_ShortCircuit : HumanIncidentWorker {
    ...
    protected override IncidentResult Execute(HumanIncidentParams @params) {
        ...
        if (!(@params is HumanIncidentParams_ShortCircuit)) {
            Tell.Err("Tried to execute " + GetType() + " but param type was " + @params.GetType());
            return ir;
        }

        HumanIncidentParams_ShortCircuit allParams = Tell.AssertNotNull((HumanIncidentParams_ShortCircuit) @params, nameof(@params), GetType().Name);
...
public class HumanIncidentParams_ShortCircuit : HumanIncidentParams {
